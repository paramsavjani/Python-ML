...
while True:
    ...
    if len(lmList) > 0:
        if len(lmList[0]) > 8:
            ...
            if length < 25:
                ...
                cv2.circle(img, (x3, y3), 12, (37, 231, 41), cv2.FILLED)
                cv2.circle(img, (x4, y4), 12, (37, 231, 41), cv2.FILLED)
                cv2.circle(img, (x5, y5), 12, (37, 231, 41), cv2.FILLED)
                cv2.line(img, (x1, y1), (x4, y4), (37, 231, 41), 3)
                cv2.line(img, (x1, y1), (x5, y5), (37, 231, 41), 3)
                cv2.line(img, (x1, y1), (x3, y3), (37, 231, 41), 3)
    ...
    cv2.putText(
        img, f"FPS: {int(fps)}", (450, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 0), 3
    )
